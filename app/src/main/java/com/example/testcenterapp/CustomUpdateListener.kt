...
class CustomUpdateListener : DistributeListener {
    ...
    override fun onReleaseAvailable(activity: Activity, releaseDetails: ReleaseDetails): Boolean {
        ...
        dialogBuilder.setTitle("Version $versionName ($versionCode)available!") // you should use a string resource instead of course, this is just to simplify example
